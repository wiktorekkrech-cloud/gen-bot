...
client.once("ready", async () => {
  ...
  console.log("✅ /opinia zarejestrowane");
});
...
client.on("interactionCreate", async (i) => {
  ...
  if (i.isButton() && i.customId === "rep-ticket") {
    const creatorId = i.channel.permissionOverwrites.cache.find(o =>
      o.allow.has(PermissionsBitField.Flags.ViewChannel) && o.type === 'member'
    )?.id;
    ...
    await i.channel.send({ content: `<@${creator.id}>`, embeds: [embed] });
