  ...
  if (message.content === "!gen fortnite") {
    ...
    const publicEmbed = new EmbedBuilder()
      ...
      .setDescription(
        ...
        "━━━━━━━━━━━━━━━━━━\n" +
        "🧠 **Jak używać:**\n" +
        "➡️ Wpisz `!gen fortnite`, aby wygenerować konto\n" +
    ...
    const dmEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name: "🔁 Kolejne konto",
          value: "Wróć na serwer i użyj `!gen fortnite`",
          inline: false
        }
      )
  ...
  if (message.content === "!stock") {
    ...
    const stockEmbed = new EmbedBuilder()
      ...
      .setDescription(
        ...
        `🌍 Wszystkie generowania: **${globalCount}**\n` +
        "━━━━━━━━━━━━━━━━━━\n" +
        "➡️ Aby wygenerować konto, użyj `!gen fortnite`"
      )
      .setFooter({ text: "Generator • Fortnite • Darmowy" })
      .setTimestamp();
