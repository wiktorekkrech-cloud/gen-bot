...
client.on("interactionCreate", async (i) => {
  ...
  if (i.isButton() && i.customId === "rep-ticket") {
    // Twórca ticketa: pierwszy człowiek z dostępem do kanału
    const creatorId = i.channel.permissionOverwrites.cache
      .filter(o => o.allow.has(PermissionsBitField.Flags.ViewChannel) && o.type === 1)
      .map(o => o.id)
      .find(id => {
